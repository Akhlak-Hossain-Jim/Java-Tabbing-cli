		...
		while (AppRunner) {
			switch (AppShifter) {
				case 0: {
					...
					int hms = Components.OptionChooser(TerminalInput, 2);
					AppShifter = hms;
					break;
				}
				case 1: {
				...
				case 11: {// SF
					...
					if (CURRENTROUND == 3) {
						...
						System.err.println(
								"\tNeed to finish round " + (CURRENTROUND + 1) + " to access SemiFinal round options.");
						AppShifter = 3;
					}
					break;
				}
				case 12: {// Final
					...
					if (CURRENTROUND == 4) {
						...
						System.err.println(
								"\tNeed to finish round " + (CURRENTROUND + 1) + " to access Final round options.");
						AppShifter = 3;
					}
					break;
				}
